...
-Creates a Spark session named "RetailerMySQLToLanding" '''
...
'''
MYSQL_CONFIG = {
    "url": "jdbc:mysql://35.196.227.218:3306/retailer_DB?useSSL=false&allowPublicKeyRetrieval=true",
...
def move_existing_files_to_archive(table):
    # Lists all files in landing/retailer-db/{table}/.
